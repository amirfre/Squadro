...
def main ():
    ...
    player2 = DQN_Agent(player=2, env=env,parametes_path=path_load)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        while not env.is_end_of_game(state_1_R):
            # Sample Environement
            action_1_R = player2.get_Action(state_1_R, epoch=epoch, black_state=state_1_R) # fix add param
            ...
            action_2 = player1.get_Action(state=state_2)
